 ...
 */
            ...
            /**
            *  GetAppRespStatus bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAppRespStatus
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAppRespStatus",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAppRespStatus",
    ...
    public static class Factory{
        ...
        */
        public static GetAppRespStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAppRespStatus object =
                new GetAppRespStatus();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAppRespStatus".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAppRespStatus)com.acme.customization.ws.einv.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
