 ...
 */
            ...
            /**
            *  GetApprovalFlowList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetApprovalFlowList
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getApprovalFlowList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getApprovalFlowList",
    ...
    public static class Factory{
        ...
        */
        public static GetApprovalFlowList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetApprovalFlowList object =
                new GetApprovalFlowList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getApprovalFlowList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetApprovalFlowList)com.acme.customization.ws.einv.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
