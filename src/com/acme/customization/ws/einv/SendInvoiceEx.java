 ...
 */
            ...
            /**
            *  SendInvoiceEx bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SendInvoiceEx
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns6");
                        ...
                        */
                                    ...
                                    protected com.acme.customization.ws.einv.DocumentType localInvoice ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.acme.customization.ws.einv.DocumentType getInvoice(){
                               return localInvoice;
                           }
                            ...
                            /**
                               ...
                               * @param param Invoice
                               */
                               public void setInvoice(com.acme.customization.ws.einv.DocumentType param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localInvoiceTracker){
                                    if (localInvoice==null){
                                        ...
                                        writeStartElement(null, "http://tempuri.org/", "invoice", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localInvoice.serialize(new javax.xml.namespace.QName("http://tempuri.org/","invoice"),
                                        xmlWriter);
                                    }
    ...
    public static class Factory{
        ...
        */
        public static SendInvoiceEx parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SendInvoiceEx object =
                new SendInvoiceEx();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"sendInvoiceEx".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SendInvoiceEx)com.acme.customization.ws.einv.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","invoice").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setInvoice(com.acme.customization.ws.einv.DocumentType.Factory.parse(reader));
