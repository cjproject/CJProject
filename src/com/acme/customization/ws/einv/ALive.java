 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static ALive parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ALive object =
                new ALive();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ALive".equals(type)){
                                ...
                                return (ALive)com.acme.customization.ws.einv.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
