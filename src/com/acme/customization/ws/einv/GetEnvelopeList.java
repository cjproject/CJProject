 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns6");
                        ...
                        */
                                    ...
                                    protected com.acme.customization.ws.einv.SendRecvType localOpType ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.acme.customization.ws.einv.SendRecvType getOpType(){
                               return localOpType;
                           }
                            ...
                            /**
                               ...
                               * @param param OpType
                               */
                               public void setOpType(com.acme.customization.ws.einv.SendRecvType param){
                            localOpTypeTracker = param != null;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getEnvelopeList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getEnvelopeList",
                ...
                if (localBeginDateTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localOpType.serialize(new javax.xml.namespace.QName("http://tempuri.org/","opType"),
                                               xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static GetEnvelopeList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetEnvelopeList object =
                new GetEnvelopeList();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getEnvelopeList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetEnvelopeList)com.acme.customization.ws.einv.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","opType").equals(reader.getName())){
                                
                                                object.setOpType(com.acme.customization.ws.einv.SendRecvType.Factory.parse(reader));
