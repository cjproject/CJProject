 ...
 */
            ...
            /**
            *  SendEnvelopeEx bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SendEnvelopeEx
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns6");
                        ...
                        */
                                    ...
                                    protected com.acme.customization.ws.einv.DocumentType localEnvelope ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.acme.customization.ws.einv.DocumentType getEnvelope(){
                            ...
                            /**
                               ...
                               */
                               public void setEnvelope(com.acme.customization.ws.einv.DocumentType param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":sendEnvelopeEx",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "sendEnvelopeEx",
                ...
                if (localEnvelopeTracker){
                                    if (localEnvelope==null){
                                        ...
                                        writeStartElement(null, "http://tempuri.org/", "envelope", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localEnvelope.serialize(new javax.xml.namespace.QName("http://tempuri.org/","envelope"),
                                        xmlWriter);
                                    }
    ...
    public static class Factory{
        ...
        */
        public static SendEnvelopeEx parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SendEnvelopeEx object =
                new SendEnvelopeEx();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"sendEnvelopeEx".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SendEnvelopeEx)com.acme.customization.ws.einv.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","envelope").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setEnvelope(com.acme.customization.ws.einv.DocumentType.Factory.parse(reader));
