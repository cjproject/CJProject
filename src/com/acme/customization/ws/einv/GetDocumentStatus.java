 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns6");
                        ...
                        */
                                    ...
                                    protected int localRelRef ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRelRefTracker = false ;

                           public boolean isRelRefSpecified(){
                               return localRelRefTracker;
                           }
                           ...
                           */
                           public  int getRelRef(){
                            ...
                            /**
                               ...
                               * @param param RelRef
                               */
                               public void setRelRef(int param){
                            
                                       // setting primitive attribute tracker to true
                                       localRelRefTracker =
                                       param != java.lang.Integer.MIN_VALUE;
                                   
                                            this.localRelRef=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDocumentStatus",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDocumentStatus",
                ...
                if (localDocTypeTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localRelRefTracker){
                                    namespace = "http://tempuri.org/";
                                    writeStartElement(null, namespace, "relRef", xmlWriter);
                             
                                               if (localRelRef==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("relRef cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRelRef));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localDocTypeTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRelRef));
                            } if (localSessionIDTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://tempuri.org/",
                                                                      "sessionID"));
    ...
    public static class Factory{
        ...
        */
        public static GetDocumentStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDocumentStatus object =
                new GetDocumentStatus();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDocumentStatus".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDocumentStatus)com.acme.customization.ws.einv.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","uuid").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","relRef").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"relRef" +"  cannot be null");
                                    }
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        reader.next();
                                               ...
                                               object.setRelRef(java.lang.Integer.MIN_VALUE);
